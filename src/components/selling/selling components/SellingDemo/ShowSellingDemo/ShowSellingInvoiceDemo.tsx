...
import SellingInvoiceTablePreview from "../../sellingWrapper/SellingInvoiceTablePreview";
import SellingInvoiceTablePreviewDemo from "./SellingInvoiceTablePreviewDemo";

const ShowSellingInvoiceDemo = () => {
  // STATE
...
export default ShowSellingInvoiceDemo;
