...
export const AddClients = ({
  ...
  const initialValues = {
    ...
    country_id:
      editClientsData?.country.id || showClientsData?.country.id || "",
    city_id: editClientsData?.city.id || showClientsData?.city.id || "",
    nationality_id:
      editClientsData?.nationality.id || showClientsData?.nationality.id || "",
    ...
    branch_name:
      editClientsData?.branch_name || showClientsData?.branch.name_ar || "",
            ...
            <div className="flex justify-end mt-8 gap-4 pl-3 ">
              ...
              {editClientsData ? (
                <Button
                  ...
                  loading={editLoading}
                  className={
                    (editLoading && "border-2 border-mainGreen bg-mainGray") ||
                    (showClientsData && "hidden")
                  }
                >
                  {t("edit")}
                </Button>
