...
export const AccessoriesTableForm = ({
  ...
  const columns: any = [
    ...
    columnHelper.accessor("accessory_tax", {
      header: `${t("added tax")}`,
      cell: (info) =>
        formatReyal(info.row.original.accessory_value_ryal * (supplierTaxDiamond ? 0 : 0.15)),
    }),
              ...
              <tr>
                ...
                <td>
                  <Field
                    ...
                    type="number"
                    value={
                      values.accessory_value * factorialValue ||
                      editData.accessory_value * factorialValue
                    }
                    className="rounded-md border-2 border-transparent focus:!border-2 focus:!border-mainGreen form-input px-4 py-[.30rem] w-full shadows"
                  />
                </td>
              ...
              <tr>
                ...
                >
                  <BaseInputField
                    ...
                    type="number"
                    noMb={true}
                    value={values.accessory_value * factorialValue}
                  />
                </td>
                <td
                  className="border-l-2  border-l-flatWhite"
                ...
                >
                  <Field
                    ...
                    name="accessory_tax"
                    value={formatReyal(
                      Number(values.accessory_value_ryal) * (supplierTaxDiamond ? 0 : 0.15)
                    )}
                    className="border-none bg-inherit outline-none cursor-default caret-transparent text-center w-full"
                  />
                </td>
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            updatedData[index] = {
                              ...
                              accessory_value:
                                values.accessory_value ||
                                editData.accessory_value,
                              accessory_amount:
                                values.accessory_amount ||
                                editData.accessory_amount,
                              accessory_weight:
                                values.accessory_weight ||
                                editData.accessory_weight,
                              accessory_value_ryal:
                                values.accessory_value * factorialValue ||
                                editData.accessory_value * factorialValue,
                              ...
                              accessory_tax:
                                values.accessory_tax || editData.accessory_tax,
                            };
                            setData(updatedData);
