...
import AddExpensesPolicies from "./AddExpensesPolicies";
...
const ViewExpensesPolicies = () => {
  ...
  const {
    ...
    endpoint: `/expenses/api/v1/majorexpences?page=${page}`,
    queryKey: ["expensesPolicies", page],
    pagination: true,
    onSuccess(data) {
...
export default ViewExpensesPolicies;
