...
import {
  ...
  SupplySecondForm,
  OTableDataTypes,
} from "../../components/supply/SupplySecondForm";
...
export const Supply = ({ title }: GoldSupplyProps_TP) => {
  ...
  ///
  if (
    checkOperationsLoading ||
    isLoadingNextBondNumber ||
    checkOperationRefetching ||
    nextBondRefetching
  )
    return (
      <Loading
  ...
  return (
    <>
      ...
      {stage !== 3 &&
        ...
        !checkOperationRefetching &&
        !nextBondRefetching && (
          <div className="mb-0 px-5 flex justify-between items-center">
      ...
      {stage === 1 &&
        ...
        !nextBondRefetching && (
          <SupplyFirstForm
            ...
            setGoldPriceToday={setGoldPriceToday}
          />
        )}
      {stage === 2 && (
        <SupplySecondForm
