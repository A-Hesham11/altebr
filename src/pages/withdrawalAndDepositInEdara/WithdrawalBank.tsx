...
const WithdrawalBank = () => {
  ...
  const {
    ...
    endpoint: `/aTM/api/v1/withDrowEdaraa?page=${page}`,
    ...
    select: (data) => {
      return data?.map((bank) => {
        return {
          ...
          frontKey: bank?.front_key_WithdrawEdaraa,
        };
      });
    },
  ...
  const handleSubmit = (values: any, resetForm: any) => {
    ...
    const formatedValue = {
      ...
      bankFrontKey: mainCardData?.base?.front_key_WithdrawEdaraa,
    ...
    mutate({
      endpointName: "/aTM/api/v1/withDrowEdaraa",
