...
const ExpensesInvoiceTable = ({ paymentData, setEditData, setPaymentData }) => {
    ...
    () => [
      {
        ...
        accessorKey: "cardItem",
        cell: (info) => {
          console.log("🚀 ~ info:", info);
          return info?.row?.original?.cardItem?.name_ar || "---";
        },
      },
      {
  ...
  return (
    <div>
      <p className="text-base font-bold">{`${t("payments")} : ${
...
export default ExpensesInvoiceTable;
