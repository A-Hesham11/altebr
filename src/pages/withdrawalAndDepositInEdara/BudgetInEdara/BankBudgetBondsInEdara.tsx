...
import InvoiceBudgetBonds from "../../Budget/budgetBonds/InvoiceBudgetBonds";
import BudgetTableEntry from "../../Budget/budgetBonds/BudgetTableEntry";

const BankBudgetBondsInEdara = () => {
  // STATE
  ...
  const {
    ...
    queryKey: ["budget-bonds-invoice-Edara"],
    endpoint:
      search === `/budget/api/v1/budgetInEladaraBond` || search === ""
        ? `/budget/api/v1/budgetInEladaraBond?page=${page}`
        : `${search}`,
    pagination: true,
  });
...
export default BankBudgetBondsInEdara;
