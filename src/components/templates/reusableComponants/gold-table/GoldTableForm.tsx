              ...
              <tr>
                ...
                <td>
                  <BaseInputField
                    ...
                    type="number"
                    value={
                      values?.stock?.replace(/\.?0+$/, "") ||
                      editData?.stock?.replace(/\.?0+$/, "")
                    }
                    onChange={(e: any) => {
                ...
                <td>
                  {!editRow && (
                    <div className="flex items-center">
                      <AiOutlinePlus
                        className="cursor-pointer text-lg font-bold rounded-md mx-auto w-[28px] h-[28px] active:shadow-none active:w-[28px]"
                        onClick={submitForm}
                      />
                      {dirty && (
                        <DeleteIcon
