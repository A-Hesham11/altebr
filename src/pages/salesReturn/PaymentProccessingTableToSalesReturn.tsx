...
const PaymentProccessingTableToSalesReturn = ({
  paymentData,
  setEditData,
  setPaymentData,
}) => {
  ...
  const table = useReactTable({
    data: paymentData,
    columns:
      path === "/expenses/expensesInvoice" ? paymentColsExpenses : paymentCols,
...
export default PaymentProccessingTableToSalesReturn;
