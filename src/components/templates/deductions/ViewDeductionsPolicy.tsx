...
import AddDeductionsPolicy from './AddDeductionsPolicy';
import { Modal } from '../../molecules';
import { Header } from '../../atoms/Header';


const ViewDeductionsPolicy = () => {
    ...
    return (
      ...
      >
        <Form>
          ...
          {isFetching && <Loading mainTitle={t("deductions policies")} />}
...
export default ViewDeductionsPolicy