...
// import { SelectMineralKarat } from "../../../../pages/coding/diamond/SelectMineralKarat"
// import { SelectMineralKarat } from "../stones/select/SelectStoneTypePurity"
...
///
export const AccessoriesTableForm = ({
  dirty,
  setDirty,
  editRow,
  categoriesOptions,
  ...
  useEffect(() => {
    if (
      ...
      values.accessory_value_ryal !== "" ||
      values.accessory_amount !== "" ||
      values.accessory_weight !== "" ||
  ...
  const columns: any = [
    ...
    columnHelper.accessor("accessory_value", {
      header: `${t("accessory value")}`,
      cell: (info) => formatReyal(info.getValue()),
    }),
    columnHelper.accessor("accessory_value_ryal", {
      header: `${t("accessory value ryal")}`,
      cell: (info) => formatReyal(info.getValue()),
    }),
    
    columnHelper.accessor("accessory_amount", {
      header: `${t("accessory amount")}`,
      cell: (info) => info.getValue(),
    }),
    // columnHelper.accessor("accessory_weight", {
    ...
    columnHelper.accessor("accessory_tax", {
      header: `${t("added tax")}`,
      cell: (info) => formatReyal(info.row.original.accessory_value_ryal * 0.15),
    }),
            ...
            {editRow ? (
              <tr>
                ...
                <td>
                  <Field
                    ...
                    type="number"
                    value={values.accessory_value || editData.accessory_value}
                    onChange={(e: any) => {
                      setFieldValue("accessory_value", e.target.value)
                    }}
                    className="rounded-md border-2 border-transparent focus:!border-2 focus:!border-mainGreen form-input px-4 py-[.30rem] w-full shadows"
                  />
                </td>
                <td>
                  <Field
                    id="accessory_value_ryal"
                    name="accessory_value_ryal"
                    type="number"
                    value={values.accessory_value*factorialValue || editData.accessory_value*factorialValue}
                    className="rounded-md border-2 border-transparent focus:!border-2 focus:!border-mainGreen form-input px-4 py-[.30rem] w-full shadows"
                  />
                </td>
                <td>
                  <Field
                    ...
                    type="number"
                    value={values.accessory_amount || editData.accessory_amount}
                    onChange={(e: any) => {
                      setFieldValue("accessory_amount", e.target.value)
                    }}
                    className="rounded-md border-2 border-transparent focus:!border-2 focus:!border-mainGreen form-input px-4 py-[.30rem] w-full shadows"
                  />
                </td>
                {/* <td>
                  <Field
                    ...
                    type="number"
                    value={values.accessory_weight || editData.accessory_weight}
                    onChange={(e: any) => {
                      setFieldValue("accessory_weight", e.target.value)
                    }}
                    className="rounded-md border-2 border-transparent focus:!border-2 focus:!border-mainGreen form-input px-4 py-[.30rem] w-full shadows"
                  />
                </td> */}
              ...
              <tr>
                ...
                <td className="border-l-2 border-l-flatWhite" style={{ minWidth: "100px" }}>
                  <BaseInputField id="accessory_value" name="accessory_value" type="number" noMb={true}  onChange={(e)=>setFieldValue('accessory_value_ryal',e.target.value*factorialValue)} />
                </td>
                <td className="border-l-2 border-l-flatWhite" style={{ minWidth: "100px" }}>
                  <BaseInputField id="accessory_value_ryal" disabled className="bg-mainGray" name="accessory_value_ryal" type="number" noMb={true} value={values.accessory_value*factorialValue} />
                </td>
                <td className="border-l-2  border-l-flatWhite" style={{ minWidth: "70px" }}>
                  <BaseInputField id="accessory amount" name="accessory_amount" type="number" noMb={true} />
                </td>
                {/* <td className="border-l-2 border-l-flatWhite" style={{ minWidth: "70px"}}>
                  <BaseInputField id="accessory_weight" name="accessory_weight" type="number" noMb={true} />
                </td> */}
                <td className="border-l-2 border-l-flatWhite" style={{ minWidth: "70px" }}>
                ...
                <td className="border-l-2 border-l-flatWhite" style={{ minWidth: "70px" }}>
                  <Field
                    ...
                    name="weight"
                    value={formatGram(
                       (Number(values.other_stones_weight) / 5) + Number(values.gold_weight)
                    )}
                ...
                <td className="border-l-2 border-l-flatWhite" style={{ minWidth: "70px" }}>
                  <Field
                    ...
                    name="accessory_tax"
                    value={formatReyal(
                      Number(values.accessory_value_ryal) * 0.15
                    )}
                    className="border-none bg-inherit outline-none cursor-default caret-transparent text-center w-full"
                  />
                </td>
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            updatedData[index] = {
                              ...
                              accessory_value: values.accessory_value || editData.accessory_value,
                              accessory_amount: values.accessory_amount || editData.accessory_amount,
                              accessory_weight: values.accessory_weight || editData.accessory_weight,
                              accessory_value_ryal: values.accessory_value*factorialValue || editData.accessory_value*factorialValue,
                              // diamond_amount: values.diamond_amount || editData.diamond_amount,
                              // accessory_stone_weight: values.accessory_stone_weight || editData.accessory_stone_weight,
                              other_stones_weight: values.other_stones_weight || editData.other_stones_weight,
                              accessory_tax: values.accessory_tax || editData.accessory_tax,
                            }
                            setData(updatedData)
