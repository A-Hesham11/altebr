...
import WasteSupplyRejectedInvoice from "../../components/selling/payoff/WasteSupplyRejectedInvoice";
import { WasteSupplyRejectedEntryFirst } from "../../components/selling/payoff/WasteSupplyRejectedEntryFirst";
import { BoxesDataBase } from "../../components/atoms/card/BoxesDataBase";
import WasteSupplyRejectedEntry from "../../components/selling/payoff/WasteSupplyRejectedEntry";
...
const WastingBonds = () => {
  ...
  return (
    <div className="">
      <h3 className="font-bold mb-5">{t("Waste")}</h3>
