...
import { AccessoriesExapndableTable } from "./AccessoriesExapndableTable"
import { AccessoriesStoneTable } from "./AccessoriesStoneTable"
    ...
    <>
      <div className="text-center">
        <AccessoriesExapndableTable
          addedPieces={[addedPieces[selectedRow[0].index - 1]]}
          showDetails={false}
        />
      </div>
      ...
      <AccessoriesStoneTable subTableData={subTableData} />
    </>
  )
}
