...
export const StoneTable = ({ subTableData }: any) => {
  ...
  console.log("🚀 ~ file: StoneTable.tsx:71 ~ StoneTable ~ selectedRow:", selectedRow)
  ...
  return (
    <>
      ...
      <div className="p-2 w-full flex items-center gap-2">
        ...
        <div>
          {!!selectedRow[0].stones[0].attachments && selectedRow[0].stones[0].attachments.length >= 0 && (
            <FilesPreviewOutFormik
              images={selectedRow[0].stones[0].attachments}
              pdfs={[]}
              preview
            />
          )} 
