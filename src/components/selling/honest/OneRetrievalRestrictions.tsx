...
///
export const OneRetrievalRestrictions = ({ sanadId }: { sanadId?: number }) => {
    /////////// VARIABLES
    ///
    ...
    const {
        ...
        endpoint: `branchSafety/api/v1/return-bond-boxes/${sanadId ? sanadId : bondId}`,
        queryKey: [`retrieve-honest-restrict-${sanadId ? sanadId : bondId}`],
        pagination: true,
        select: (contract: any) => {
            return {
